...
```
cd existing_repo
git remote add origin https://gitlab.epfl.ch/voland/sc_unguided_callback1_team142.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.epfl.ch/voland/sc_unguided_callback1_team142/-/settings/integrations)
